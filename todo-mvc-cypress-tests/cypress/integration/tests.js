...
describe('TodoMVC', () => {
  ...
  const urls = [
    `${host}/react/index.html`
    // `${host}/react/index-1-count/index-1-count.html`,
    // `${host}/react/index-2-count-toggle/index-2-count-toggle.html`,
    // `${host}/react/index-3-count-toggle-filters/index-3-count-toggle-filters.html`,
    // `${host}/react/index-4-count-toggle-filters-input/index-4-count-toggle-filters-input.html`,
    // `${host}/react/index-5-count-toggle-filters-input-item/index-5-count-toggle-filters-input-item.html`,
    // `${host}/react/index-6-count-toggle-filters-input-item-list/index-6-count-toggle-filters-input-item-list.html`,
    // `${host}/vue/index.html`,
    // `${host}/vue/index-1-count/index-1-count.html`,
    // `${host}/vue/index-2-count-toggle/index-2-count-toggle.html`,
    // `${host}/vue/index-3-count-toggle-filters/index-3-count-toggle-filters.html`,
    // `${host}/vue/index-4-count-toggle-filters-input/index-4-count-toggle-filters-input.html`,
    // `${host}/vue/index-5-count-toggle-filters-input-item/index-5-count-toggle-filters-input-item.html`,
    // `${host}/vue/index-6-count-toggle-filters-input-item-list/index-6-count-toggle-filters-input-item-list.html`
  ];
  urls.forEach(function(url) {
    describe(`TodoMVC - ${url}`, function() {
